...
\begin{titlepage} 
	...
	\textsc{\LARGE Stedelijk Gymnasium}\\[1.5cm] % Onze school
	
	\textsc{\Large Thermodynamica}\\[0.5cm] % Hoofdonderwerp 
	...
	{\huge\bfseries Proef 1}\\[0.4cm] % Hoofdtitel
	...
	\vfill\vfill
	\includegraphics[width=0.2\textwidth]{LogoFysica}\\[1cm] % Ons fysica logootje
